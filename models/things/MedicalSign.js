...
var schema = new Schema({ identifyingExam: { type: Schema.Types.ObjectId, ref: 'identifyingExam' },
  identifyingTest: { type: Schema.Types.ObjectId, ref: 'identifyingTest' },
...
module.exports = mongoose.model('MedicalSign', schema);