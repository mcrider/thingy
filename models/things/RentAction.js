...
var schema = new Schema({ landlord: { type: Schema.Types.ObjectId, ref: 'landlord' },
  realEstateAgent: { type: Schema.Types.ObjectId, ref: 'realEstateAgent' },
...
module.exports = mongoose.model('RentAction', schema);