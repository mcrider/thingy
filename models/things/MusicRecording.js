...
var schema = new Schema({ inPlaylist: { type: Schema.Types.ObjectId, ref: 'inPlaylist' },
  inAlbum: { type: Schema.Types.ObjectId, ref: 'inAlbum' },
  duration: { type: Schema.Types.ObjectId, ref: 'duration' },
  byArtist: { type: Schema.Types.ObjectId, ref: 'byArtist' },
...
module.exports = mongoose.model('MusicRecording', schema);