...
var schema = new Schema({ assembly: { type: Schema.Types.ObjectId, ref: 'assembly' },
  assemblyVersion: { type: Schema.Types.ObjectId, ref: 'assemblyVersion' },
  programmingModel: { type: Schema.Types.ObjectId, ref: 'programmingModel' },
  targetPlatform: { type: Schema.Types.ObjectId, ref: 'targetPlatform' },
  dependencies: { type: Schema.Types.ObjectId, ref: 'dependencies' },
  proficiencyLevel: { type: Schema.Types.ObjectId, ref: 'proficiencyLevel' },
  articleBody: { type: Schema.Types.ObjectId, ref: 'articleBody' },
  articleSection: { type: Schema.Types.ObjectId, ref: 'articleSection' },
  wordCount: { type: Schema.Types.ObjectId, ref: 'wordCount' },
...
module.exports = mongoose.model('APIReference', schema);