...
var schema = new Schema({ includedRiskFactor: { type: Schema.Types.ObjectId, ref: 'includedRiskFactor' },
  estimatesRiskOf: { type: Schema.Types.ObjectId, ref: 'estimatesRiskOf' },
...
module.exports = mongoose.model('MedicalRiskEstimator', schema);