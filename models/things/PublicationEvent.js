...
var schema = new Schema({ publishedOn: { type: Schema.Types.ObjectId, ref: 'publishedOn' },
  free: { type: Schema.Types.ObjectId, ref: 'free' },
...
module.exports = mongoose.model('PublicationEvent', schema);