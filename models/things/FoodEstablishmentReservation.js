...
var schema = new Schema({ endTime: { type: Schema.Types.ObjectId, ref: 'endTime' },
  startTime: { type: Schema.Types.ObjectId, ref: 'startTime' },
  partySize: { type: Schema.Types.ObjectId, ref: 'partySize' },
...
module.exports = mongoose.model('FoodEstablishmentReservation', schema);