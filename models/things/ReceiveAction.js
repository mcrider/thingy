...
var schema = new Schema({ sender: { type: Schema.Types.ObjectId, ref: 'sender' },
  deliveryMethod: { type: Schema.Types.ObjectId, ref: 'deliveryMethod' },
...
module.exports = mongoose.model('ReceiveAction', schema);