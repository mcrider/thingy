...
var schema = new Schema({ appliesToDeliveryMethod: { type: Schema.Types.ObjectId, ref: 'appliesToDeliveryMethod' },
  appliesToPaymentMethod: { type: Schema.Types.ObjectId, ref: 'appliesToPaymentMethod' },
