...
var schema = new Schema({ specialty: { type: Schema.Types.ObjectId, ref: 'specialty' },
  significantLinks: { type: Schema.Types.ObjectId, ref: 'significantLinks' },
...
module.exports = mongoose.model('CollectionPage', schema);