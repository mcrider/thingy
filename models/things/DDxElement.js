...
var schema = new Schema({ diagnosis: { type: Schema.Types.ObjectId, ref: 'diagnosis' },
  distinguishingSign: { type: Schema.Types.ObjectId, ref: 'distinguishingSign' },
...
module.exports = mongoose.model('DDxElement', schema);