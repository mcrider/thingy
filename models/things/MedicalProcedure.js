...
var schema = new Schema({ followup: { type: Schema.Types.ObjectId, ref: 'followup' },
  howPerformed: { type: Schema.Types.ObjectId, ref: 'howPerformed' },
  preparation: { type: Schema.Types.ObjectId, ref: 'preparation' },
  procedureType: { type: Schema.Types.ObjectId, ref: 'procedureType' },
...
module.exports = mongoose.model('MedicalProcedure', schema);