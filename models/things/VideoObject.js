...
var schema = new Schema({ caption: { type: Schema.Types.ObjectId, ref: 'caption' },
  ...
  videoFrameSize: { type: Schema.Types.ObjectId, ref: 'videoFrameSize' },
  videoQuality: { type: Schema.Types.ObjectId, ref: 'videoQuality' },
...
module.exports = mongoose.model('VideoObject', schema);