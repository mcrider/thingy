...
var schema = new Schema({ tributary: { type: Schema.Types.ObjectId, ref: 'tributary' },
  regionDrained: { type: Schema.Types.ObjectId, ref: 'regionDrained' },
  drainsTo: { type: Schema.Types.ObjectId, ref: 'drainsTo' },
...
module.exports = mongoose.model('Vein', schema);