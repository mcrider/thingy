...
var schema = new Schema({ codeValue: { type: Schema.Types.ObjectId, ref: 'codeValue' },
  codingSystem: { type: Schema.Types.ObjectId, ref: 'codingSystem' },
...
module.exports = mongoose.model('MedicalCode', schema);