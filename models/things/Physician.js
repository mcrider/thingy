...
var schema = new Schema({ availableService: { type: Schema.Types.ObjectId, ref: 'availableService' },
  hospitalAffiliation: { type: Schema.Types.ObjectId, ref: 'hospitalAffiliation' },
  medicalSpecialty: { type: Schema.Types.ObjectId, ref: 'medicalSpecialty' },
  ...
  url: { type: Schema.Types.ObjectId, ref: 'url' },
  potentialAction: { type: Schema.Types.ObjectId, ref: 'potentialAction' } });
module.exports = mongoose.model('Physician', schema);