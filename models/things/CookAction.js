...
var schema = new Schema({ recipe: { type: Schema.Types.ObjectId, ref: 'recipe' },
  foodEvent: { type: Schema.Types.ObjectId, ref: 'foodEvent' },
  foodEstablishment: { type: Schema.Types.ObjectId, ref: 'foodEstablishment' },
...
module.exports = mongoose.model('CookAction', schema);