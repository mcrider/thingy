...
var schema = new Schema({ hasDeliveryMethod: { type: Schema.Types.ObjectId, ref: 'hasDeliveryMethod' },
  availableThrough: { type: Schema.Types.ObjectId, ref: 'availableThrough' },
  availableFrom: { type: Schema.Types.ObjectId, ref: 'availableFrom' },
...
module.exports = mongoose.model('DeliveryEvent', schema);