...
var schema = new Schema({ scheduledTime: { type: Schema.Types.ObjectId, ref: 'scheduledTime' },
  scheduledTime: { type: Schema.Types.ObjectId, ref: 'scheduledTime' },
...
module.exports = mongoose.model('ReserveAction', schema);