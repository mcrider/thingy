...
var schema = new Schema({ pickupLocation: { type: Schema.Types.ObjectId, ref: 'pickupLocation' },
  dropoffLocation: { type: Schema.Types.ObjectId, ref: 'dropoffLocation' },
  pickupTime: { type: Schema.Types.ObjectId, ref: 'pickupTime' },
  dropoffTime: { type: Schema.Types.ObjectId, ref: 'dropoffTime' },
...
module.exports = mongoose.model('RentalCarReservation', schema);