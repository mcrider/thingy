...
var schema = new Schema({ replacer: { type: Schema.Types.ObjectId, ref: 'replacer' },
  replacee: { type: Schema.Types.ObjectId, ref: 'replacee' },
  collectionModel: { type: Schema.Types.ObjectId, ref: 'collectionModel' },
...
module.exports = mongoose.model('ReplaceAction', schema);