...
var schema = new Schema({ caption: { type: Schema.Types.ObjectId, ref: 'caption' },
  exifData: { type: Schema.Types.ObjectId, ref: 'exifData' },
  representativeOfPage: { type: Schema.Types.ObjectId, ref: 'representativeOfPage' },
  thumbnail: { type: Schema.Types.ObjectId, ref: 'thumbnail' },
...
module.exports = mongoose.model('ImageObject', schema);