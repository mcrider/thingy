...
var schema = new Schema({ checkinTime: { type: Schema.Types.ObjectId, ref: 'checkinTime' },
  checkoutTime: { type: Schema.Types.ObjectId, ref: 'checkoutTime' },
  lodgingUnitType: { type: Schema.Types.ObjectId, ref: 'lodgingUnitType' },
  lodgingUnitDescription: { type: Schema.Types.ObjectId, ref: 'lodgingUnitDescription' },
  numAdults: { type: Schema.Types.ObjectId, ref: 'numAdults' },
  numChildren: { type: Schema.Types.ObjectId, ref: 'numChildren' },
...
module.exports = mongoose.model('LodgingReservation', schema);