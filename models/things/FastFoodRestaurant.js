...
var schema = new Schema({ servesCuisine: { type: Schema.Types.ObjectId, ref: 'servesCuisine' },
  menu: { type: Schema.Types.ObjectId, ref: 'menu' },
  acceptsReservations: { type: Schema.Types.ObjectId, ref: 'acceptsReservations' },
...
module.exports = mongoose.model('FastFoodRestaurant', schema);