...
var schema = new Schema({ valueAddedTaxIncluded: { type: Schema.Types.ObjectId, ref: 'valueAddedTaxIncluded' },
...
module.exports = mongoose.model('PriceSpecification', schema);