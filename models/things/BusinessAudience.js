...
var schema = new Schema({ numberofEmployees: { type: Schema.Types.ObjectId, ref: 'numberofEmployees' },
  yearlyRevenue: { type: Schema.Types.ObjectId, ref: 'yearlyRevenue' },
  yearsInOperation: { type: Schema.Types.ObjectId, ref: 'yearsInOperation' },
