...
var schema = new Schema({ subReservation: { type: Schema.Types.ObjectId, ref: 'subReservation' },
  reservationId: { type: Schema.Types.ObjectId, ref: 'reservationId' },
...
module.exports = mongoose.model('ReservationPackage', schema);