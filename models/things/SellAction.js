...
var schema = new Schema({ buyer: { type: Schema.Types.ObjectId, ref: 'buyer' },
  warrantyPromise: { type: Schema.Types.ObjectId, ref: 'warrantyPromise' },
...
module.exports = mongoose.model('SellAction', schema);