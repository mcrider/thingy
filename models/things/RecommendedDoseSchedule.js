...
var schema = new Schema({ targetPopulation: { type: Schema.Types.ObjectId, ref: 'targetPopulation' },
  frequency: { type: Schema.Types.ObjectId, ref: 'frequency' },
  doseValue: { type: Schema.Types.ObjectId, ref: 'doseValue' },
  doseUnit: { type: Schema.Types.ObjectId, ref: 'doseUnit' },
...
module.exports = mongoose.model('RecommendedDoseSchedule', schema);