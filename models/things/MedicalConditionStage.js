...
var schema = new Schema({ stageAsNumber: { type: Schema.Types.ObjectId, ref: 'stageAsNumber' },
  subStageSuffix: { type: Schema.Types.ObjectId, ref: 'subStageSuffix' },
...
module.exports = mongoose.model('MedicalConditionStage', schema);