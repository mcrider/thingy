...
var schema = new Schema({ runsTo: { type: Schema.Types.ObjectId, ref: 'runsTo' },
  regionDrained: { type: Schema.Types.ObjectId, ref: 'regionDrained' },
  originatesFrom: { type: Schema.Types.ObjectId, ref: 'originatesFrom' },
...
module.exports = mongoose.model('LymphaticVessel', schema);