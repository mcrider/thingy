...
var schema = new Schema({ muscleAction: { type: Schema.Types.ObjectId, ref: 'muscleAction' },
  antagonist: { type: Schema.Types.ObjectId, ref: 'antagonist' },
  bloodSupply: { type: Schema.Types.ObjectId, ref: 'bloodSupply' },
  insertion: { type: Schema.Types.ObjectId, ref: 'insertion' },
  nerve: { type: Schema.Types.ObjectId, ref: 'nerve' },
...
module.exports = mongoose.model('Muscle', schema);